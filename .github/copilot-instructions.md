...
- Use `yarn cy:run:auto --spec "src/applications/.../*.cypress.spec.js"` to run headless Cypress tests with temp yarn watch on a free port with failure output + screenshots
