...
This guide walks through implementing the VA.gov Prefill Pattern end-to-end: frontend work in vets-website and backend work in vets-api. The pattern displays user information (name, SSN, DOB, contact info) in prefilled read-only cards, pulling data from VA Profile and save-in-progress endpoints.
