const all = {
  data: [
    ...
    {
      id: 'F253-7227761-1833512',
      type: 'clinical_note',
      attributes: {
        id: 'F253-7227761-1833512',
        name: 'AMBULATORY CARE PAIN ASSESSMENT',
        noteType: 'physician_procedure_note',
        loincCodes: ['11506-3'],
        ...
        addenda: [
          {
            ...
            signedBy: 'MARCI P MCGUIRE',
            note:
              'VGhpcyBpcyBhbiBhZGRlbmR1bSB0byBNYXJjaSdzIGluaXRpYWxseSBjcmVhdGVkIG5vdGUuIDEyMzQ1Njc4OTAhQCMkJV4mKigpDQo=',
          },
        ],
        source: 'vista',
      },
