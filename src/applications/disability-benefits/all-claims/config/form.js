...
const formConfig = {
  ...
  chapters: {
     ...
     * | V3     | Enhancement ON, FileInputV3 ON  | va-file-input-multiple (WC)  | `-enhancement` |
     *
     * "V3" uses the newest web component and is the target end-state.
     ...
     *   - disability526SupportingEvidenceFileInputV3   — gates V3 vs V1 upload component
     */
    supportingEvidence: {
