export const conditionObjects = [
  ...
  { option: 'agoraphobia' },
  { option: 'AL amyloidosis (primary amyloidosis)' },
  { option: 'alopecia' },
  ...
  { option: 'asbestosis, silicosis, or other pneumoconiosis' },
  { option: 'asthma' },
  {
  ...
  { option: 'back pain or stiffness, diagnosis unknown' },
  ...
  { option: 'conversion disorder (FNSD)' },
  ...
  { option: 'delirium' },
  { option: 'delusional disorder' },
  { option: 'depersonalization-derealization disorder (DPDR)' },
  ...
  { option: 'dissociative amnesia' },
  { option: 'dissociative identity disorder' },
  ...
  { option: 'eosinophilic granuloma of lung' },
  ...
  { option: 'foot pain or strain, diagnosis unknown', sideOfBody: true },
  ...
  { option: 'hip pain or limited motion, diagnosis unknown', sideOfBody: true },
  ...
  { option: 'knee pain or stiffness, diagnosis unknown', sideOfBody: true },
  ...
  { option: 'lower back pain or stiffness, diagnosis unknown' },
  ...
  { option: 'neck pain or stiffness, diagnosis unknown' },
  ...
  { option: 'onychomycosis (toenail fungus)' },
  ...
  { option: 'pulmonary alveolar proteinosis (PAP)' },
  ...
  { option: 'restless leg syndrome (RLS)' },
  ...
  { option: 'schizoaffective disorder' },
  { option: 'schizophrenia' },
  { option: 'sciatica (sciatic nerve radiculopathy)', sideOfBody: true },
  { option: 'scoliosis' },
  ...
  { option: 'shoulder pain or stiffness, diagnosis unknown', sideOfBody: true },
  ...
  { option: 'social anxiety disorder (social phobia)' },
