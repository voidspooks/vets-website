import testData from './schema/child-test.json';
import preneedHelpers from './utils/cypress-preneed-helpers';

describe('Pre-need form VA 40-10007 Unmarried Child Workflow', () => {
  it('fills the form as an unmarried adult child of a veteran', () => {
    preneedHelpers.interceptSetup();
    preneedHelpers.visitIntro();

    // Applicant Information - Unmarried adult child relationship
