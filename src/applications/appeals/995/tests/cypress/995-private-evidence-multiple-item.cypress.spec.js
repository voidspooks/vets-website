...
import { fetchItf } from '../../../shared/tests/cypress.helpers';
import {
  detailsEntryContent,
  introContent,
  summaryContent,
  ...
  describe('Private evidence only', () => {
    it('navigates through the evidence pages adding multiple items', () => {
      ...
      h.checkErrorHandlingWithClass(
        h.PRIVATE_EVIDENCE_PROMPT_RADIOS,
      ...
      h.addPrivateLocationData(locationOneDetails);
      ...
      h.addPrivateLocationData(locationTwoDetails);
      ...
      const locationThreeDetails = {
        name: 'Uptown Urgent Care',
        addressLine1: '900 75th St.',
        city: 'Baltimore',
        stateCode: 'MD',
        zip: '21287',
        addressLine2: '#235',
      ...
      h.addPrivateLocationData(locationThreeDetails);
      ...
      h.verifyArrayBuilderReviewPrivateCard(
        ...
        {
          ...locationTwoDetails,
          name: 'Baltimore Methodist General Hospital',
        },
        2,
      ...
      // ---------------------------------------- DELETING FIRST ITEM
      h.clickArrayBuilderDeleteCardButton(0);
