...
import PrivatePromptReview from '../components/evidence/PrivatePromptReview';
...
import limitedConsentPromptPage, {
  reviewTitle as lcReviewTitle,
    ...
    evidence: {
      ...
      pages: {
        ...
        privatePrompt: {
          ...
          CustomPageReview: PrivatePromptReview,
          uiSchema: privatePrompt.uiSchema,
          schema: privatePrompt.schema,
          scrollAndFocusTarget: focusRadioH3,
        },
        privateAuthorization: {
          title: content4142.title,
          path: EVIDENCE_PRIVATE_AUTHORIZATION_URL,
          CustomPage: Authorization,
          CustomPageReview: AuthorizationReview,
        ...
        summary: {
          ...
          scrollAndFocusTarget: focusAlertH3,
          depends: formData => !shouldHideEvidenceSummaryPage(formData),
        },
      },
    },
    vhaIndicator: {
