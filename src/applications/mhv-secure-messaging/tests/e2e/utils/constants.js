...
export const Locators = {
  ...
  FOLDERS: {
    ...
    FOLDER_REMOVE: '[data-testid="remove-this-folder"]',
    FOLDER_REMOVE_DATA_TEST_ID: 'remove-this-folder',
  ...
  BUTTONS: {
    ...
    TEST2: 'radiobutton-TEST2',
    TESTAGAIN: 'radiobutton-TESTAGAIN',
    NEW_FOLDER_RADIOBTN: 'folder-list-radio-button',
    DELETE_RADIOBTN: 'radiobutton-Deleted',
    MOVE: `#move-button`,
    TRASH: `#trash-button`,
  ...
  ALERTS: {
    ...
    ALERT_MODAL: 'navigation-warning-modal',
    SM_ROUTE_NAV_GUARD_MODAL: 'sm-route-navigation-guard-modal',
