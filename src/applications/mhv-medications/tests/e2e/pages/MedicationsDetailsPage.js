...
class MedicationsDetailsPage {
  ...
  clickMedicationListAndDetailsLink = prescriptionDetails => {
    cy.intercept(
      'GET',
    ...
    cy.get('a[data-testid="medications-list-details-link"]')
      .first()
      .click({ force: true });
  };
  ...
  clickMedicationDetailsLink = (prescriptionDetails, cardNumber) => {
    ...
    cy.get(
      `[data-testid="medication-list"] > :nth-child(${cardNumber}) [data-testid="medications-list-details-link"]`,
    ).should('be.visible');
    cy.get(
      `[data-testid="medication-list"] > :nth-child(${cardNumber}) [data-testid="medications-list-details-link"]`,
    )
