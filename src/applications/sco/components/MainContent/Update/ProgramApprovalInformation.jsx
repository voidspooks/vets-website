...
const ProgramApprovalInformation = () => {
  ...
  return (
    ...
    >
      ...
      />
      <LiSpanAndVaLinkAndPTag
        href="https://www.benefits.va.gov/gibill/vettec2_training_provider_faqs.asp"
        hrefText="VET TEC 2.0 Approvals"
        pText="Learn more about the approval process for the VET TEC 2.0 program and find answers to common questions for prospective training providers."
      />
      <LiSpanAndVaLinkAndPTag
