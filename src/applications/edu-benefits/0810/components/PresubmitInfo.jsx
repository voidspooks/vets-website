...
function PresubmitInfo({ formData, showError, user, onSectionComplete }) {
  ...
  const handleCheckboxChange = useCallback(
    event => {
      dispatch(
        setData({
          ...formData,
          statementOfTruthCertified: event.detail.checked,
        }),
      );
    },
    [formData],
  ...
  const handleInputChange = useCallback(
    event => {
      dispatch(
        setData({
          ...formData,
          statementOfTruthSignature: event.detail.value,
        }),
      );
    },
    [formData],
