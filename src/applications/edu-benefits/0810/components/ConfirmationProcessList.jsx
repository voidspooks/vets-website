    ...
    <va-process-list uswds>
          ...
          <p>
            ...
            <span className="vads-u-display--inline-block">
              <va-link
                ...
                text="Download your completed VA Form 22-0810"
              />
            </span>
          </p>
        </div>
      ...
      <va-process-list-item header="Gather relevant attachments">
        <div itemProp="itemListElement">
          ...
          <ul>
            <li>
              The receipt for the exam fees, <strong>and</strong>
            </li>
      ...
      >
        <div itemProp="itemListElement">
          <p>
            ...
            />
            {', '}
            and upload your saved VA Form 22-0810 as well as your receipt and
