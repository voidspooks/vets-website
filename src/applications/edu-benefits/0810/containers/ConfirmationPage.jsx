...
export const ConfirmationPage = props => {
  ...
  return (
    ...
    >
      ...
      {!form.data.hasPreviouslyApplied && (
        <p>
          You must also submit VA Form 22-1990 and apply for VA Education
          Benefits before we can process your reimbursement request.
        </p>
      )}
    </ConfirmationView>
  );
