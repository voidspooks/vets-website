...
export const eligibilityScreenerUiSchema = {
  eligibilityScreener: {
    ...
    enteredServiceOnOrAfterOct2003: radioUI({
      title:
        'Did you first enter military service on or after October 1, 2003?',
      hint:
        'This is the date you first reported to your branch of service for initial active duty training.',
      labels: {
        Y: 'Yes',
        N: 'No',
      },
