    ...
    trainingProgramChapter: {
      ...
      pages: {
        ...
        flightTrainingRequirements: {
          ...
          uiSchema: flightTrainingUiSchema,
          schema: flightTrainingSchema,
          depends: formData =>
            !!(
              formData.trainingProgram &&
              formData.trainingProgram.trainingType &&
              formData.trainingProgram.trainingType.vocationalFlightTraining ===
                true
            ),
        },
        schoolInformation: {
        ...
        uploadVoidedCheck: {
          ...
          depends: formData =>
            !!(
              ...
              formData.contactInformation.directDeposit &&
              formData.contactInformation.directDeposit.enrolling === true
            ),
        },
      },
    },
