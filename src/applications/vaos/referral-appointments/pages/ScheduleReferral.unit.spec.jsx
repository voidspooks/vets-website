...
describe('VAOS Component: ScheduleReferral', () => {
  ...
  it('should show the original has-appointments-content when hasAppointments is true but no alreadyScheduledAlert state', async () => {
    const referral = createReferralById(referralDate, 'no-state-flag');
    referral.attributes.hasAppointments = true;
