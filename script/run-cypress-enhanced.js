 ...
 *   - Uses CYPRESS_FAILURE_HOOKS: '1' to get better failure output
 *
 * Flags:
...
const DEFAULT_SERVE = false;
const DEFAULT_NO_RETRY = false;
const DEFAULT_NO_VIDEO = false;
const DEFAULT_NO_TIMEOUT = false;
...
let serve = DEFAULT_SERVE;
let noRetry = DEFAULT_NO_RETRY;
let noVideo = DEFAULT_NO_VIDEO;
let noTimeout = DEFAULT_NO_TIMEOUT;
let specPath = null;
...
Flags:
  --serve          Start and stop a dev server automatically (default: off)
  --no-retry       Disable retries (default: off)
  --no-video       Skip video recording (default: off)
  --timeout N      Hard process timeout in seconds (default: 180)
  --no-timeout     Disable hard timeout (default: off)
  --verbose        Show full Cypress output (default: summary only)
